\_Web Project: Homeland (De Pátria para Pátria)
...
\_Descrição do Projeto
O site consiste em uma galeria digital que apresenta as origens e histórias da equipe. O foco do desenvolvimento foi a estruturação do conteúdo e a adaptação do layout para diferentes tamanhos de tela.
...
\_Tecnologias e Metodologias Utilizadas
...
\_Autoria
Desenvolvido por: Victória Paz (2026)
